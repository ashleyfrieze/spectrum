...
public interface ParameterizedDefinitionBlock<T> {
	...
	@FunctionalInterface
	interface ThreeArgBlock<T1, T2, T3> extends ParameterizedDefinitionBlock<ThreeArgBlock<T1, T2, T3>> {
		void run(T1 arg0, T2 arg1, T3 arg2);
	}

	@FunctionalInterface
	interface FourArgBlock<T1, T2, T3, T4> extends ParameterizedDefinitionBlock<FourArgBlock<T1, T2, T3, T4>> {
