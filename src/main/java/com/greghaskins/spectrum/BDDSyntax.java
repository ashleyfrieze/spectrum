 ...
 * Note - the beforeEach and afterEach will still be executed between given/when/then steps which may
 * not make sense in many situations.
 */
public class BDDSyntax {
	...
	/**
	 * Describes a scenario of the system. These can be at root level, though are best grouped inside features.
	...
	public static void scenario(final String scenarioName, final Block block) {
		describe("Scenario: " + scenarioName, block);
	}
